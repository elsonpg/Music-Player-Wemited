...
import com.frontier.musicplayer.ITimberService;
import com.frontier.musicplayer.MusicPlayer;
import com.frontier.musicplayer.MusicService;
import com.frontier.musicplayer.R;
import com.frontier.musicplayer.dialogs.DialogUtils;
import com.frontier.musicplayer.listeners.MusicStateListener;
import com.frontier.musicplayer.mp3cutter.RingdroidSelectActivity;
import com.frontier.musicplayer.slidinguppanel.SlidingUpPanelLayout;
import com.frontier.musicplayer.subfragments.QuickControlsFragment;
import com.frontier.musicplayer.utils.Helpers;
import com.frontier.musicplayer.utils.NavigationUtils;
import com.frontier.musicplayer.utils.SleepTimer;
import com.frontier.musicplayer.utils.TimberUtils;

import java.lang.ref.WeakReference;
import java.util.ArrayList;

import static com.frontier.musicplayer.MusicPlayer.mService;
...
public class BaseActivity extends ATEActivity implements ServiceConnection, MusicStateListener {
    ...
    private HmsPickerDialogFragment.HmsPickerDialogHandler mHmsPickerHandler = new HmsPickerDialogFragment.HmsPickerDialogHandler() {
        ...
        public void onDialogHmsSet(int reference, int hours, int minutes, int seconds) {
            ...
            SleepTimer.setTimer(BaseActivity.this, prefs, hours * 3600 + minutes * 60 + seconds);
        }
    };
        ...
        public void onClick(DialogInterface dialog, int which) {
            switch(which) {
                case DialogInterface.BUTTON_POSITIVE: // set a new timer
                    DialogUtils.showSleepHmsPicker(BaseActivity.this, mHmsPickerHandler);
                    break;
                case DialogInterface.BUTTON_NEGATIVE: // cancel the current timer
                    SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(BaseActivity.this);
                    SleepTimer.cancelTimer(BaseActivity.this, prefs);
                    break;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.mp3_cutter:
                Intent startIntent = new Intent(this, RingdroidSelectActivity.class);
